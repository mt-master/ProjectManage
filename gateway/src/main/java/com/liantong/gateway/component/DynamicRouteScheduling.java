package com.liantong.gateway.component;

import com.liantong.gateway.pojo.GatewayFilterDefinition;
import com.liantong.gateway.pojo.GatewayPredicateDefinition;
import com.liantong.gateway.pojo.GatewayRouteDefinition;
import com.liantong.gateway.service.DynamicRouteServiceImpl;
import com.liantong.gateway.util.JsonUtils;
...
public class DynamicRouteScheduling {
	...
	private static final String dynamicRouteServerName = "usermanage";
		...
		try {
			...
			if (resultVersionId != null && versionId != resultVersionId) {
				...
				if (!StringUtils.isEmpty(resultRoutes)) {
					List<GatewayRouteDefinition> list = JsonUtils.jsonToList(resultRoutes, GatewayRouteDefinition.class);
